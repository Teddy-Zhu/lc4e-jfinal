...
public class CustomPlugin implements IPlugin {
    ...
    private static Map<String, Object> injectObjs;

    private static Map<String, List<Field>> injectFields;
    ...
    static {
        ...
        annotationFunctionMap.put(ValidateComVars.class, (x) -> new ValidateComVarsResolver((ValidateComVars) x, validateKit));
        annotationFunctionMap.put(ValidateComVar.class, (x) -> new ValidateComVarResolver((ValidateComVar) x, validateKit));
        annotationFunctionMap.put(ValidateParams.class, (x) -> new ValidateParamsResolver((ValidateParams) x, validateKit));
        annotationFunctionMap.put(SetComVar.class, (x) -> new SetComVarResolver((SetComVar) x, attributeKit));
        annotationFunctionMap.put(SetComVars.class, (x) -> new SetComVarsResolver((SetComVars) x, attributeKit));
    ...
    public boolean enable() throws InstantiationException {
        initRoutes();
        ...
        Classes.forEach(service -> {
            ...
            for (Field fieldTmp : fields) {
                ...
                if (fieldTmp.isAnnotationPresent(Inject.class)) {
                    ...
                    injectObjs.put(clzss.getName(), tmp);
                }
            }
            injectFields.put(service.getName(), fieldList);
        });
    }
    ...
    public static Map<String, Object> getInjectObjs() {
        return injectObjs;
    }

    public static Map<String, List<Field>> getInjectFields() {
        return injectFields;
    }
}
