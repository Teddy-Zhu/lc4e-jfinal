 ...
 */
@CustomAnnotation
public class ValidateParamsAnnotationResolver extends CustomAnnotationPlugin {
    @Override
    ...
    public Object intercept(Annotation annotation, AnnotationPluginResolver resolver, Object[] objects, Object target, Method method, boolean[] isHandled) throws Throwable {
        ValidateKit.resolveParameters(CustomPlugin.getValidateKit(), (ValidateParams) annotation, (Controller) target);
