...
import com.teddy.jfinal.annotation.ValidateFunctionValues;
 ...
 */
public class ValidateFunctionValuesAnnotationResolver implements CustomAnnotationPlugin {
    @Override
    public Class<? extends Annotation> getAnnotation() {
        return ValidateFunctionValues.class;
    }
    ...
    public Object intercept(Annotation annotation, AnnotationPluginResolver resolver, Object[] objects, Object target, Method method, boolean[] isHandled) throws Throwable {
        ValidateFunctionValues ans = (ValidateFunctionValues) annotation;

        for (ValidateFunctionValue an : ans.value()) {
